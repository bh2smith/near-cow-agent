...
- ALWAYS uses Token Units for amount
ORDER KIND:
...
TOOL SPECIFIC
- getQuote: Display the transaction responses one at a time sequentially. Use the meta.summary data to describe what they are signing. Keep the descriptions brief.
    ...
    paths: {
      "/api/tools/quote": {
        get: {
          ...
          summary:
            "Retrive quote from CoW API. Returns quote and signable payloads.",
          description: `Quote a price and fee for the specified order parameters. Returns the quote and payload for signing. In some cases, this tool will return multiple SignRequests. For example (wrapping ETH and/or sell token approvals). The last SignRequest will always be the user's swap order.`,
          parameters: [
            ...
            "application/json": {
              schema: {
                ...
                properties: {
                  ...
                  summary: {
                    description:
                      "Human readable summary of returned signature requests.",
                    type: "string",
                    example: "1. Off Chain Order Placement (EIP712)",
                  },
                  transaction: { $ref: "#/components/schemas/SignRequest" },
                },
                required: ["meta", "summary", "transaction"],
              },
            },
          },
        },
      ...
      schemas: {
        ...
        BaseTokenInfo: {
          ...
          properties: {
            ...
            symbol: {
              type: "string",
              description: "Ticker symbol, e.g., USDC.",
              example: "GNO",
            },
            decimals: {
              type: "integer",
            ...
            contractAddress: {
              type: "string",
              description: "Token contract address (chain-specific).",
            },
          },
        ...
        OrderParameters: {
          ...
          properties: {
            ...
            sellAmount: {
              ...
              allOf: [{ $ref: "#/components/schemas/BigUint" }],
            },
            buyAmount: {
          ...
          properties: {
            network: {
              ...
              properties: {
                name: {
                  type: "string",
                  description: "Network name, e.g., Ethereum, NEAR.",
                },
                icon: {
                  type: "string",
                  format: "uri",
            ...
            type: {
              type: "string",
              enum: ["swap"],
              description: "Discriminator for the data type.",
            },
            fee: {
              type: "string",
              description:
                "Swap fee as a decimal string (currency/context-dependent).",
            },
            tokenIn: { $ref: "#/components/schemas/TokenInfo" },
            tokenOut: { $ref: "#/components/schemas/TokenInfo" },
          },
          required: ["network", "type", "fee", "tokenIn", "tokenOut"],
          example: {
            network: {
              name: "Gnosis",
            ...
            type: "swap",
            fee: "0.000000362051326969",
            tokenIn: {
              contractAddress: "0x6a023ccd1ff6f2045c3309768ead9e68f978f6e1",
              amount: "0.001",
              usdValue: 4.523136383780001,
              price: 4523.136383780001,
            ...
            tokenOut: {
              ...
              amount: "12.961710780075342126",
              usdValue: 4.4699972166005875,
              price: 0.3448616693,
        ...
        TokenInfo: {
          allOf: [
            { $ref: "#/components/schemas/BaseTokenInfo" },
            {
              type: "object",
              additionalProperties: false,
              properties: {
                amount: {
                  type: "string",
                  description: "Token amount as a decimal string (not scaled).",
                },
                usdValue: {
                  type: "number",
                  format: "double",
                  description: "Approximate USD valuation.",
                },
              },
              required: ["amount", "usdValue"],
            },
          ],
        },
      },
