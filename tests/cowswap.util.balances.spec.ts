...
describe('getSafeBalances', () => {
  const mockNotSafeAddress = '0x1234567890123456789012345678901234567890' as Address;
  const mockBalances = [
    {
  ...
  describe('with real network calls', () => {
    it.skip('should fetch balances for Arbitrum', async () => {
      const result = await getSafeBalances(42161, "0x2A42b97d2cd622a0e2B5AB8dC5d6106fb7a122c5");
